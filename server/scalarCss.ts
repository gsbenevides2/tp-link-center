...
.dark-mode {
  ...
  --scalar-color-accent: #4beaf9;

  --scalar-background-1: oklch(0.582 0.082 204);
  --scalar-background-2: oklch(0.455 0.05 203);
  --scalar-background-3: oklch(0.339 0.05 203);
  --scalar-background-accent: oklch(43.5% 0.029 321.78);

  --scalar-border-color: oklch(0.339 0.05 203);
}
...
.light-mode,
.dark-mode {
  --scalar-button-1: oklch(0.455 0.05 203);
  --scalar-button-1-color: #fff;
  --scalar-button-1-hover: rgb(28 31 33);

  --scalar-color-green: #03e459;
  --scalar-color-red: #ef0006;
  --scalar-color-yellow: #edbe20;
  --scalar-color-blue: #01f2ff;
  --scalar-color-orange: #2cfb51;
  --scalar-color-purple: #001719;
